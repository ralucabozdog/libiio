...
To read the gain attribute from an ADC device channel:

.. code-block:: console

   io_attr -u serial:/dev/ttyACM0 -c iio-device@0 voltage0 gain
   1

To write the gain attribute to an ADC device channel:

.. code-block:: console

   io_attr -u serial:/dev/ttyACM0 -c iio-device@0 voltage0 gain 2
   2
